...
export const createProject = async (req, res) => {
  ...
  if (process.env.USE_MOCK_DB === 'true') {
    ...
    // 1. Construct Mock Declaration Object (mimicking DB record)
    const mockDeclaration = {
        declaration_id: id,
        mail_subject: `[TEST] Declaration ${id} - Auto-Generated Ticket`,
        odoo_body: `This ticket was automatically created from the Dashboard (Mock Mode).\n\nDeclaration ID: ${id}\nTime: ${new Date().toISOString()}\n\nPlease verify integration.`,
