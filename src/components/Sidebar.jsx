...
const Sidebar = ({ collapsed, toggle }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      subtitles: [
        { label: 'Performance', path: '/statistics/performance', allowedRoles: ['admin', 'developer'] },
        { label: 'User Management', path: '/statistics/user-management', allowedRoles: ['admin', 'developer'] },
        { label: 'HR Intelligence AI', path: '/statistics/ai-chat', allowedRoles: ['admin', 'developer'] },
        { label: 'AI Guide', path: '/statistics/ai-guide', allowedRoles: ['admin', 'developer'] },
      ],
      hasSubmenu: true,
    },
    {
      id: 'customs-ai',
      label: 'Customs Assistant',
      icon: Bot,
    ...
    },
    {
      ...
      subtitles: [
        { label: 'Flows', path: '/rules/flows', allowedRoles: ['developer'] },
        { label: 'Run Checks', path: '/rules/run', allowedRoles: ['developer'] },
      ],
      hasSubmenu: true,
    },
    {
      ...
      subtitles: [
        ...
        { label: 'Brain Analytics',     path: '/monitoring/brain', allowedRoles: ['developer'] },
      ],
      hasSubmenu: true,
    },
  ];
